...
describe('simple arithmetic tests', () => {
    const tests = [
        ...
        {testName: 'power test', program: '9 ^ 5', expectedData: [59049], expectedType: 'numeric'},
...
describe('complex arithmetic tests', () => {
    const tests = [
        ...
        {testName: '1 ^ y gives 1', program: '1 ^ 3000', expectedData: [1], expectedType: 'numeric'},
        {testName: 'y ^ 0 gives 1', program: '3000 ^ 0', expectedData: [1], expectedType: 'numeric'},
        {testName: 'x ^ y gives Infinity for y = Infinity', program: '32 ^ Inf', expectedData: [Infinity], expectedType: 'numeric'},
